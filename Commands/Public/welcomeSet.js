...
const welcomeSchema = require('../../mongoSchemas/welcomeSchemas');
const leaveSchema = require('../../mongoSchemas/leaveSchemas');
...
module.exports = {  
    ...
    .addSubcommand((options) => options
      ...
      .addAttachmentOption((opt) => opt
        .setName('image')
        .setDescription('Set an custom leave image')
      )
    )
    .addSubcommand((options) => options
      .setName('remove')
    ...
    async execute(interaction, client) {
        ...
        switch (sub) {
            case 'welcome-set': {
                ...
                const welcomeImage = options.getAttachment('image') || "https://cdn.discordapp.com/attachments/968292399208091749/1034897621803860018/0001_0.png";
              ...
              if (!data) {
                ...
                interaction.reply({
                    embeds: [
                        ...
                        .setDescription(`Welcome channels set to:\n${welcomeCH}\n\nCustom Messages:\n${welcomeMsg}\n\nCustom Image set to:`)
                ...
                interaction.reply({
                    embeds: [
                        new EmbedBuilder()
                        .setTitle('Welcomer has been Updated Successfully')
                        .setDescription(`Welcome channels Updated to :\n${welcomeCH}\n\nCustom Messages Updated to :\n${welcomeMsg}\n\nCustom Image Updated to:`)
                        .setImage(welcomeImage.url)
                        .setColor('#5FD7FF')
                    ],
                    ephemeral: true
        ...
        case 'leave-set': {
            ...
            const leaveImage = options.getAttachment('image') || "https://cdn.discordapp.com/attachments/968292399208091749/1034897621803860018/0001_0.png";
            ...
            leaveSchema.findOne({ Guild: interaction.guild.id },async (err, data) => {
                if (!data) {
                  ...
                  interaction.reply({
                    embeds: [
                      new EmbedBuilder()
                      .setTitle('Leave Message has been Set Successfully')
                      .setDescription(`Leave channels set to:\n${leaveCH}\n\nCustom Messages:\n${leaveMsg}\n\nCustom Image set to:`)
                  ...
                  interaction.reply({
                    embeds: [
                        new EmbedBuilder()
                        .setTitle('Leave Message has been Updated Successfully')
                        .setDescription(`Leave channels Updated to :\n${leaveCH}\n\nCustom Messages Updated to :\n${leaveMsg}\n\nCustom Image Updated to:`)
                        .setImage(leaveImage.url)
                        .setColor('#5FD7FF')
                    ],
                    ephemeral: true
                ...
                case 'wlc':
                    ...
                    if (data) {
                        ...
                        interaction.reply({
                            embeds: [
                                new EmbedBuilder()
                                .setTitle('Successfully removed the welcomer')
                                .setColor('#5FD7FF')
                            ],
                        ephemeral: true
                    })
                      ...
                      interaction.reply({
                        embeds: [
                            ...
                            .setDescription('Your server have not been registered/ you have never used the welcomer')
                            .setColor('#FF000A')
                        ],
                        ephemeral: true
                      })
                ...
                leaveSchema.findOne({ Guild: interaction.guild.id }, async (err, data) => {
                    if (data) {
                        ...
                        interaction.reply({
                            embeds: [
                                new EmbedBuilder()
                                .setTitle('Successfully removed the leave message')
                            .setColor('#5FD7FF')
                            ],
                            ephemeral: true
                        })
                        ...
                        interaction.reply({
                            embeds: [
                                new EmbedBuilder()
                                .setTitle('Failed to remove welcomer')
                            .setDescription('Your server have not been registered/ you have never used the leave message')
                            .setColor('#FF000A')
                            ],
                            ephemeral: true
                        })
